const images = [
    ...
    text: 'Often described as puffy, cotton-like or cauliflower-shaped clouds; their shape is due to their formation via atmospheric convection. They are usually spotted in fair weather conditions.'},
    ...
    text: ' Generally grey or blue-tinged with a largely-uniform blanket-like appearance. They are composed of water droplets and/or ice crystals, because they are the result of the condensation of water vapor. They constitute 1/3 of the Earth\'s total cloud coverage.'},
...
function clickHeightButton (event) {
    cloudGame.displayAlert(imageName);
